namespace GleyDailyRewards
{
    ...
    {
        private const string FOLDER_NAME = "DailyRewards";
        ...
        private void OnEnable()
        {
            ...
            {
                GameObject popup = AssetDatabase.LoadAssetAtPath($"{rootFolder}/Prefabs/CalendarPopup.prefab", typeof(GameObject)) as GameObject;
            ...
            {
                GameObject canvas = AssetDatabase.LoadAssetAtPath($"{rootFolder}/Prefabs/CalendarPopupCanvas.prefab", typeof(GameObject)) as GameObject;
        ...
        private void CreateDailyRewardsSettings()
        {
            ...
            AssetDatabase.CreateAsset(asset, $"{rootFolder}/Resources/DailyRewardsSettingsData.asset");
        ...
        void OnGUI()
        {
            ...
            {
                EditorSceneManager.OpenScene($"{rootFolder}/Example/TimerButtonExample.unity");
            }

            if (GUILayout.Button("Open Calendar Example"))
            {
                EditorSceneManager.OpenScene($"{rootFolder}/Example/CalendarExample.unity");
            }
        ...
        private void CreateEnumFile()
        {
            ...
            text += "}";
            File.WriteAllText($"{Application.dataPath}/{rootWithoutAssets}/Scripts/TimerButtonIDs.cs", text);
            AssetDatabase.Refresh();
        }
